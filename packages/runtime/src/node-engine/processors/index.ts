...
import { ContourPivotProcessor, contourPivotDef } from './contour-pivot'
...
import { PublishRootProcessor, publishRootDef } from './publish-root'
import { TapZoneProcessor, tapZoneDef } from './tap-zone'
import { ConstantContourProcessor, constantContourDef } from './constant-contour'
import { ConstantTextureProcessor, constantTextureDef } from './constant-texture'
...
export const PROCESSOR_CATALOG: Record<string, ProcessorEntry> = {
    ...
    contourPivot:    { def: contourPivotDef,    create: () => new ContourPivotProcessor() },
