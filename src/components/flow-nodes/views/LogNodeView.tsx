...
import { SectionTitle, SliderField } from '../widgets'
import { COL_SECONDARY, COL_DIVIDER } from '../widgets/constants'
import { useSetParam } from '../hooks/useSetParam'
import { logDef, LogProcessor } from '../../../node-engine/processors/log'
import type { EffectMetrics } from '../../../node-engine/types'
...
export const LogNodeView = memo(function LogNodeView(
    ...
    return (
        ...
        >
            {!snapshot ? (
                <Typography variant="caption" sx={{ color: COL_SECONDARY, fontSize: 11 }}>
                    Wire an Effect node's `metrics` output to start measuring.
                </Typography>
            ) : (
                <Stack spacing={0.75}>
