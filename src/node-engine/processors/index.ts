...
import { SDFProcessor, sdfDef } from './sdf'
...
import { DepthProjectProcessor, depthProjectDef } from './depth-project'
...
import { EdgeDetectProcessor, edgeDetectDef } from './edge-detect'
...
import { TextRemovalMaskProcessor, textRemovalMaskDef } from './text-removal-mask'
import { QwenImageEditProcessor, qwenImageEditDef } from './qwen-image-edit'
import { RerouteProcessor, rerouteDef } from './reroute'
...
export const PROCESSOR_CATALOG: Record<string, ProcessorEntry> = {
    ...
    sdf:          { def: sdfDef,          create: () => new SDFProcessor() },
    ...
    depthProject: { def: depthProjectDef, create: () => new DepthProjectProcessor() },
    ...
    edgeDetect:   { def: edgeDetectDef,  create: () => new EdgeDetectProcessor() },
    ...
    textRemovalMask: { def: textRemovalMaskDef, create: () => new TextRemovalMaskProcessor() },
    qwenImageEdit: { def: qwenImageEditDef, create: () => new QwenImageEditProcessor() },
    reroute:      { def: rerouteDef,      create: () => new RerouteProcessor() },
