...
export default `
    ...
    uniform vec4 uChan_phase;      // x = time_ms — drives ray rotation phase
    ...
    void main(){
        ...
        /* Progress drives the appearance ramp; uChan_progress.z is 0..1. */
        float s = uChan_progress.z;
        ...
        if (a0) acc += layer(theta, sdist, uColor0, uRayStrength3.x, uRayDensity3.x, uRaySpeed3.x, uRayFalloff3.x, uJoinSoftness3.x, uRayPhaseOffsetFrac3.x, apearInter);
        if (a1) acc += layer(theta, sdist, uColor1, uRayStrength3.y, uRayDensity3.y, uRaySpeed3.y, uRayFalloff3.y, uJoinSoftness3.y, uRayPhaseOffsetFrac3.y, apearInter);
        if (a2) acc += layer(theta, sdist, uColor2, uRayStrength3.z, uRayDensity3.z, uRaySpeed3.z, uRayFalloff3.z, uJoinSoftness3.z, uRayPhaseOffsetFrac3.z, apearInter);
        ...
        acc *= depthMask * uChan_intensity.z;
