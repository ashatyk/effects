...
import { FrameNodeSettings } from './settings/FrameNodeSettings'

// Right-rail Settings panes; parallel to pipelineNodeTypes but with no RF chrome. Processors
// absent from this map have no editable controls (visualisers / aliases / actions-only).
