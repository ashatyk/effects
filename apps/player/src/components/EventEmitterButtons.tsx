...
interface Props {
    // Only `kind: 'event'` zones; `kind: 'tap'` go through canvas hit-test.
    zones: PublishedTapZone[]
    player: EffectPlayer | null
}

// Per-button bump counter gives visual confirmation the click landed even
// when the downstream effect's onset is delayed (e.g. long-attack envelope).
